...
st.write("Upload your PNG images or PDF files, convert them to clean Markdown via Gemini AI, and download an **editable Word Document**. Developed by VUU in collaboration with **Gemini AI**.")
